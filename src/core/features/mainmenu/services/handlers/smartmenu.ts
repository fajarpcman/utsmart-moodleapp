...
export class CoreMainMenuSmartHandlerService implements CoreMainMenuHandler {

    static readonly PAGE_NAME = 'smart';
    ...
    getDisplayData(): CoreMainMenuHandlerData {
        return {
            ...
            page: CoreMainMenuSmartHandlerService.PAGE_NAME,
...
export const CoreMainMenuSmartHandler = makeSingleton(CoreMainMenuSmartHandlerService);
