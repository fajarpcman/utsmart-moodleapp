 ...
 */
export type CoreMainMenuSmartHandler = CoreDelegateDisplayHandler<CoreMainMenuSmartHandlerToDisplay>;

/**
 * Data needed to render a main menu handler. It's returned by the handler.
 */
export interface CoreMainMenuSmartHandlerData {
    /**
 ...
 */
export interface CoreMainMenuSmartHandlerToDisplay extends CoreDelegateToDisplay, CoreMainMenuSmartHandlerData {}
...
export class CoreMainMenuSmartDelegateService extends CoreSortedDelegate<CoreMainMenuSmartHandlerToDisplay, CoreMainMenuSmartHandler> {

    protected featurePrefix = 'CoreMainMenuSmartDelegate_';

    constructor() {
        super('CoreMainMenuSmartDelegate');
    }

}

export const CoreMainMenuSmartDelegate = makeSingleton(CoreMainMenuSmartDelegateService);
